            ...
            <div className="panel">
                ...
                <div style={{ marginBottom: '50px', paddingBottom: '40px', borderBottom: '1px solid var(--border)' }}>
                    ...
                    <div style={{ background: 'rgba(59, 130, 246, 0.15)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #3b82f6' }}>
                        <strong style={{ color: '#60a5fa' }}>The Golden Rule:</strong> If a step feels too hard or overwhelming, you haven't decomposed it enough. Break it down again!
                    </div>
                </div>
                ...
                <div style={{ marginBottom: '50px', paddingBottom: '40px', borderBottom: '1px solid var(--border)' }}>
                    ...
                    <div style={{ background: 'rgba(20, 184, 166, 0.15)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #14b8a6' }}>
                        <strong style={{ color: '#5eead4' }}>The Fix:</strong> Replace vague adjectives with absolute values. "Walk forward 5 steps." "Stir for 30 seconds."
                    </div>
                </div>

            ...
            <div className="panel">
                ...
                <div style={{ marginBottom: '50px', paddingBottom: '40px', borderBottom: '1px solid var(--border)' }}>
                    ...
                    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '20px', borderRadius: '12px' }}>
                        <strong style={{ color: '#c084fc' }}>Real-World Benefit:</strong> By applying algorithmic precision and sequencing to your morning routine, you eliminate the groggy mistakes that ruin your morning.
                    </div>
                </div>
                ...
                <div style={{ marginBottom: '50px', paddingBottom: '40px', borderBottom: '1px solid var(--border)' }}>
                    ...
                    <div style={{ background: 'rgba(139, 92, 246, 0.1)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #8b5cf6', marginBottom: '20px' }}>
                    ...
                    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '20px', borderRadius: '12px' }}>
                        <strong style={{ color: '#c084fc' }}>Real-World Benefit:</strong> Algorithmic logic prevents catastrophic failures. By defining clear rules (If/Then) for your laundry, you protect your valuable clothes from destruction.
                    </div>
                </div>
                ...
                <div style={{ marginBottom: '50px' }}>
                    ...
                    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '20px', borderRadius: '12px' }}>
                        <strong style={{ color: '#c084fc' }}>Real-World Benefit:</strong> Understanding iteration means you don't panic when things go wrong. You simply view the obstacle as a "bug" in the system, adjust your algorithm, and keep moving forward efficiently.
                    </div>
                </div>
